...
export default function Edit({ route, navigation }) {
    ...
    const [detalleCompra, setDetalle] = useState([]);
        ...
        const solicitud = await fetch(
            'http://192.168.0.11:6001/api/compras/modificar?IdCompra=' + parseInt(id),
            {
                ...
                body: JSON.stringify({
                    ...
                    Sucursales_IdSucursal: parseInt(valueSucursales),
                    Proveedores_IdProveedor: 1
                })
            }
        )
    ...
    const flat = () => {
        ...
        return detalleCompra.map((item) => {
            return (
                <Pressable onPress={()=> 
                {
                    navigation.navigate('E_DetalleCompra', {id: id, productoId: item.Productos_IdProducto, precio: item.PrecioCompra, cantidad: item.Cantidad});
                    setVisible(false);
                }}>
                 <View style={styles.containerProducto}>
                        <View style={styles.containerFilaPro}>
                            ...
                            <View style={styles.containerInfo}>
                                ...
                                <Text style={styles.textPrecio}>{"Precio: L " + item.PrecioCompra}</Text>
                                <Text style={styles.textPrecio}>{"Total: L " + (item.PrecioCompra * item.Cantidad)}</Text>
                            </View>
                        </View>
                    </View>
                </Pressable>
                ...
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <View style={styles.containerInput}>
                            ...
                            >
                                <View style={styles.containerPmodal}>
                                    <View style={styles.conatinerInfoModal}>
                                        <Text style={styles.textTittle}>Detalle Compra</Text>
                            ...
                            >
                                <View style={styles.containerPmodalModificar}>
                                    <View style={styles.conatinerInfoModalModificar}>
                                        ...
                                        <Text style={styles.textmessagemodalModificar}>Compra Modificada</Text>
                        ...
                        <View style={styles.containerPri}>
                            <Text style={styles.textTittle}>Editar Compra</Text>
